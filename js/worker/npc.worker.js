...
self.onmessage = (message) => {
    switch (message.type) {
        case message_interface_1.NpcMessageType.ADD:
            ...
            break;
        case message_interface_1.NpcMessageType.GET:
            npcStorage.get()
                .then((npcs) => {
                self.postMessage({ guid: message.guid, type: message_interface_1.MessageType.CONFIRMATION, sender: message_interface_1.MessagePeer.Npc, receiver: message_interface_1.MessagePeer.Host, content: npcs });
            });
            break;
    }
};
